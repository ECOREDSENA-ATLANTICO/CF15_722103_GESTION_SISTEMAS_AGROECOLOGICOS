  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.cs
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero 
        span 1
      h1 Labores de manejo animal por especie
      
    .row.align-items-center.justify-content-center.mb-5
        
      p.mb-4 Las labores de manejo son las actividades que se realizan para sujetar, inmovilizar, derribar, transportar, castrar, topizar, identificar y/o registrar los animales en la producción pecuaria con el fin de mejorar el funcionamiento de la empresa. Dado lo anterior revisemos el manejo por diferentes especies:
