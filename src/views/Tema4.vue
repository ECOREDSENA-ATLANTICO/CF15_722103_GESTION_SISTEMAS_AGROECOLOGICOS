      ...
      .col-lg-10
        .tarjeta-avatar-b.mb-3
          .tarjeta-avatar-b__img.h-100
            img.img-t.m-auto.w-50(src='@/assets/curso/images/tema4/img_2.svg', alt='')
          .tarjeta.color-primario.shadow-sm
            .row.justify-content-between.align-items-center
              .col.mb-3.mb-sm-0
                p.mb-3 Igualmente, es importante que pueda profundizar a través de la web algunas características adicionales de la anatomía de las especies pecuarias, para lo cual se le invita a que descargue la siguiente información:   
                p.mb-3 Bertucci, A. Anatomia y Fisiologia Animal. Facultad de Ciencias Agrarias.    
              .col-sm-auto
